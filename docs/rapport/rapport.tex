    ...
    \begin{titlepage}
        ...
        \begin{center}
            \begin{tikzpicture}[remember picture, overlay]
                ...
                \node[left]  at ($(titre.west)-(0.5,0)$) {\includegraphics[width=5cm]{images/kawwai.pdf}};
                \node[right] at ($(titre.east)+(0.5,0)$) {\scalebox{-1}[1]{\includegraphics[width=5cm]{images/kawwai.pdf}}};
